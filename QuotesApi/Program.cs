...
static void MapCollectionEndpoints(WebApplication app)
{
        ...
        CancellationToken cancellationToken) =>
    {
        ...
        return collection is null
            ? Results.NotFound()
            : Results.Ok(ToCollectionResponse(collection));
    });
        ...
        CancellationToken cancellationToken) =>
    {
        ...
        return Results.Ok(ToCollectionResponse(collection));
    }).RequireAuthorization("can-edit-quotes");
...
static object ToCollectionResponse(Collection collection) => new
{
    collection.Id,
    collection.Name,
    collection.OwnerId,
